...
import type { OrganizacionStep1Data, FormData } from '../../../types/formTypes';
      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2">
          <select
            ...
            name="tipoDocumento"
            value={formData.datosOrganizacion?.tipoDocumento ?? 'NIT'}
            onChange={handleChange}
            disabled
          >
          ...
          <input
            ...
            value={formData.datosOrganizacion?.numeroDocumento ?? ''}
            onChange={handleChange}
